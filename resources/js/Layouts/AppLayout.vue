<template>
    <div class="min-h-screen bg-gray-100">
        <nav class="bg-white border-b border-gray-100">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <jet-nav-link :href="route('route.index')" :active="route().current('route.index')">
                                Routes
                            </jet-nav-link>
                            <jet-nav-link :href="route('service.index')" :active="route().current('service.index')">
                                Services
                            </jet-nav-link>
                            <jet-nav-link :href="route('auth.index')" :active="route().current('auth.index')">
                                Auths
                            </jet-nav-link>
                        </div>
                    </div>
            ...
            <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                <div class="pt-2 pb-3 space-y-1">
                    ...
                    <jet-responsive-nav-link :href="route('route.index')" :active="route().current('route.index')">
                        Routes
                    </jet-responsive-nav-link>

                    <jet-responsive-nav-link :href="route('service.index')" :active="route().current('service.index')">
                        Services
                    </jet-responsive-nav-link>

                    <jet-responsive-nav-link :href="route('auth.index')" :active="route().current('auth.index')">
                        Auths
                    </jet-responsive-nav-link>
                </div>
                ...
                <div class="pt-4 pb-1 border-t border-gray-200">
                    ...
                    <div class="mt-3 space-y-1">
                        ...
                        <jet-responsive-nav-link :href="route('user.index')" :active="route().current('user.index')">
                            Manage Users
                        </jet-responsive-nav-link>
        ...
        <header class="bg-white shadow">
            <div class="max-w-7xl mx-auto flex items-center px-4 sm:px-6 lg:px-8" style="height: 70px">
                <div style="width: 100%">
